        ...
        <div className={styles.convList}>
          ...
          <div className={styles.convCard}>
            ...
            <div className={styles.convInfo}>
              ...
              <span className={styles.convPreview}>I&rsquo;m having trouble with the login again.</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className={styles.chatHistory}>
          ...
          <div className={`${styles.messageRow} ${styles.incoming}`}>
            <div className={styles.bubble}>
              Hi, I ordered the premium subscription yesterday but haven&rsquo;t received the activation link yet. Could you check on that?
            </div>
          ...
          <div className={`${styles.messageRow} ${styles.outgoing}`}>
            <div className={styles.bubble}>
              Found it! It looks like there was a slight delay in the automation. I&rsquo;ve manually triggered the activation now. You should see it in your inbox in 2 minutes.
            </div>
